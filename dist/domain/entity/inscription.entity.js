...
class InscriptionEntity {
    constructor(id, uuid, studentUuid, programUuid, programVersionUuid, eventReceivingQueueUuid, institutionAbbreviation, modality, status, lang, registeredAt, programStartedAt, programFinishedAt, extensionFinishedAt, processWhen, processed, createdAt, updatedAt, deletedAt, introductoryModule) {
        this.id = id;
        this.uuid = uuid;
